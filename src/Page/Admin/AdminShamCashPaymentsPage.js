...
import AdminShamCashPayments from "../../Components/Admin/AdminShamCashPayments";

const AdminShamCashPaymentsPage = () => {
  return (
...
export default AdminShamCashPaymentsPage;
